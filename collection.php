	...
	<body>
	    ...
	    <main role="main">
	      	<div class="container">
		        <div class="row">
					<h2>Collection</h2>
					<p class="lead">Below is a list of every assembly that has been uploaded, parsed and saved to your collection. Click on an assembly to view corresponding studies, structures and sequences.</p>
