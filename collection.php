						...
						<tbody>
							<?php
								...
								foreach ($objCollection->assemblies as $arrAssembly) {
									echo "<tr><td><a href='assembly_view.php?id=".$arrAssembly["id"]."'>".$arrAssembly["name"]."</a></td><td>".$arrAssembly["study_count"]."</td><td>".number_format($arrAssembly["structure_count"])."</td><td>".number_format($arrAssembly["sequence_length"])."</td></tr>";
								}
								//****************************************************************************************************************
